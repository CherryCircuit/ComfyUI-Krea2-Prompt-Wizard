...
class FrontendPackagingTests(unittest.TestCase):
    ...
    def test_entrypoint_loads_helpers_before_registration(self):
        ...
        self.assertIn('await import("./js/state.mjs?v=12")', source)
        self.assertIn('await import("./js/wizard_widget.mjs?v=12")', source)
    ...
    def test_wizard_has_prompt_motion_and_model_outputs(self):
        self.assertEqual(Krea2PromptWizard.RETURN_TYPES, ("STRING", "STRING", "MODEL"))
        self.assertEqual(
    ...
    def test_wizard_compiles_embedded_state(self):
        ...
        self.assertEqual(result["result"], ("portrait of a traveler", "", None))
