...
await import("./js/state.mjs?v=3");
await import("./js/searchable_selector.mjs?v=3");
await import("./js/preset_row.mjs?v=3");
await import("./js/library_editor.mjs?v=3");
await import("./js/materialize.mjs?v=3");
await import("./js/inspector.mjs?v=3");
await import("./js/wizard_widget.mjs?v=3");

const stylesheet = document.createElement("link");
stylesheet.rel = "stylesheet";
stylesheet.href = new URL("./css/wizard.css?v=3", import.meta.url).href;
