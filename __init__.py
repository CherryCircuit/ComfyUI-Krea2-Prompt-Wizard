...
# ComfyUI looks for ``WEB_DIRECTORY`` at the top of the package to expose
# ``web/`` as a static extension directory.
WEB_DIRECTORY = os.path.basename(WEB_DIR) if os.path.isdir(WEB_DIR) else None
